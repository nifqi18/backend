...
class AuthService {
  ...
  async login (auth, email, password) {
    ...
    try {
      ...
      switch (error.name) {
        case 'UserNotFoundException': message = 'Username and Password tidak cocok'; break
        case 'PasswordMisMatchException': message = 'Username dan Password tidak cocok'; break
      }
